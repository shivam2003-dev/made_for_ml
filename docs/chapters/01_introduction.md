...
!!! example "Detailed Walkthrough"
    ...
    **Step 2: Feature Representation**
    - Each email → vector of 1000 features (word frequencies)
...
!!! example "Detailed Walkthrough"
    ...
    **Step 2: Feature Engineering**
    ...
    - Encode categorical: zip code → one-hot encoding
...
- **Data** ↔ **Model**: More data generally improves model quality (up to a point)
...
- **Training Error** ↔ **Test Error**: Gap indicates overfitting
